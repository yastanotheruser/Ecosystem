...
public class EcosystemDialog extends JDialog {
    ...
    public EcosystemDialog(JFrame parent, boolean modal, int width, int height) {
        super(parent, modal);
        this.width = width;
        this.height = height;
    ...
    public EcosystemDialog(JFrame parent, boolean modal) {
        this(parent, modal, DEFAULT_WIDTH, DEFAULT_HEIGHT);
    }
